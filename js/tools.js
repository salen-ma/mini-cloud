...
fq.animate = function(obj, attrs, duration, fx, fn) {
  ...
  obj.timer = setInterval(function() {
    ...
    for (var key in changeVal) {
      var val = fq.Tween[fx](t, startVal[key], changeVal[key], duration);
...
fq.css = function() {
  ...
  function getStyle(attr) {
    return attr == 'width' || attr == 'height' || attr == 'left' || attr == 'bottom' || attr == 'top' || attr == 'right' || attr == 'margin-left' || attr == 'marginLeft' || attr == 'margin-right' || attr == 'marginRight' || attr == 'margin-bottom' || attr == 'marginBottom' || attr == 'margin-top' || attr == 'marginTop';
  }
...
fq.setTransform = function(obj, attr, val) {
  var attrs = obj._transform = obj._transform || {};
...
fq.hasClassName = function(obj, cls) {
  var clsName = obj.className.split(' ');
  return clsName.includes(cls);
}

fq.addClassName = function(obj, cls) {

  if (!fq.hasClassName(obj, cls)) {
    obj.className += ' ' + cls;
  }
  obj.className = obj.className.trim();
};

fq.rmClassName = function(obj, cls) {
  if (fq.hasClassName(obj, cls)) {
    var clsName = obj.className.split(' ');
